...
# PROBLEM 6
# Create an array called `colors` and set it equal to a list of at least 
#five colors.
...
# Problem 8
# Use a for-in loop to iterate over the `numbers` array and print each 
#number.
...
# Use a for-in loop to iterate over the `numbers` array, and if a number 
#is even, add  it to the `even_numbers` array.
...
#to the end of the array (similar to push() in JavaScript), then add a 
#name to the end of the `friends` array.

friends.append('Alaina')
print(friends)

# Problem 13
# Print out the total amount of elements in the `friends` array. 
# The Python method you are looking for is similar to the JavaScript 
# property `.length`.
...
friends.insert(2, 'Alaina')
print(friends)

# Problem 15
# Remove the last item in the array (try to think about how you can do 
# this dynamically, meaning, if the array contents were to change, 
